            ...
            {isOpen && (
                ...
                >
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        <Link to="/services" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-gold">Services</Link>
                        <Link to="/projects" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-gold">Projects</Link>
                        <Link to="/about" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-base font-medium text-gray-300 hover:text-gold">About</Link>
                    </div>
                </motion.div>
            )}
        </nav>
